"""
Kernel Events: Async In-Memory Pub/Sub Event Bus
================================================
Coordinates asynchronous notifications for state changes, step executions,
and human approval triggers without tight coupling between components.
"""
