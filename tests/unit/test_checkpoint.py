"""
Test Suite: SQLite CheckpointStore Working Memory & Rollbacks
=============================================================
Tests proving:
  1. Transactional persistence of missions, steps, and checkpoints.
  2. Point-in-time state rollbacks with historical causal cleanup.
  3. WAL mode pragma activation on disk-backed databases.
  4. Isolation between multiple concurrent mission sessions.
"""
...
class TestCheckpointStore:
    ...
    def test_database_initialization_and_wal_mode(self, tmp_workspace: Path) -> None:
        ...
        # Check WAL mode is enabled on disk
